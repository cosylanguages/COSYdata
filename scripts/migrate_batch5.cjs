...
// Batch 5 sources and target mappings
const sources = [
  { file: 'time.js', target: 'time.json' },
  { file: 'numbers.js', target: 'numbers.json' },
  { file: 'family.js', target: 'family.json' },
  { file: 'nature.js', target: 'geography.json' }
];
...
console.log(`Batch 5 Complete: Added ${addedNew} new entries, updated ${updatedLevels} levels in higher files, skipped ${skippedDuplicates} existing A0/A1 duplicates.`);
