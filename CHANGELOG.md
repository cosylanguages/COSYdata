...
- Complete English CEFR A0–C2 general and A0–A1 spoken vocabulary datasets in `vocabulary/en/`. Entries shared between courses are marked with `domain: "general, spoken"` and tagged `"spoken"`.
