...
### Added
- Migrated and converted 447 French A1 candidate vocabulary entries from COSYlanguages into `vocabulary/fr/a0_a1/` across 21 theme files, expanding French A0/A1 vocabulary total from 516 to 963 entries.
