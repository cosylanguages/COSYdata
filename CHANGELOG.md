...
- Complete English CEFR A0–C2 general vocabulary and A0–B2 spoken English vocabulary datasets in `vocabulary/en/`. Entries shared between general and spoken courses are tagged with `domain: "general, spoken"`.
