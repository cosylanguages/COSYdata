...
| **French (`fr`)** | 963 | 963 | 39 | 0 | 4.0% | ✅ **Compliant / Annotated** |
...
- **Total Entries Audited**: 963
- **Verified A0/A1 Compliant**: 963 (100.0%)
- **Over-Level Flagged**: 0
- **Audit Findings**: All 963 French entries in `vocabulary/fr/a0_a1/` correspond strictly to DELF A1 core thematic domains (greetings, personal identification, daily routines, food, weather, family, clothing, numbers, time). No subjective intuitive flags were applied. All items are fully compliant with DELF A1 standards.
